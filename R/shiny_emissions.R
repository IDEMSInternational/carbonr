...
shiny_emissions <- function(){
                                                                              ...
                                                                              shiny::tabsetPanel(type = "tabs",
                                                                                                 shiny::tabPanel("Flights",
                                                                                                                 shiny::splitLayout(shinydashboard::box(width = NULL,
                                                                                                                                                        shiny::textInput(inputId = "flightfrom", label = "From:", value = "LHR", width = "41%"),
                                                                                                                                                        shiny::textInput(inputId = "flightto", label = "To:", value = "NBO", width = "41%"),
                                                                                                                                                        shiny::numericInput("flightvia", "Via:", value = 0, min = 0, width = "41%"),
                                                                                                                                                        shiny::uiOutput("flightvia_input"),
                                                                                                                                                        shiny::radioButtons(inputId = "flightclass", label = "Flight Class:", c("Economy" = "economy", "Premium Economy" = "premium economy", "Business" = "business", "First" = "first")),
                                                                                                                                                        shiny::numericInput(inputId = "numberflying", label = "Number of people:", value = 1, width = "41%"),
                                                                                                                                                        shiny::checkboxInput(inputId = "radiative", label = "Account for radiative forcing", value = TRUE, width = "20%"),
                                                                                                                                                        shiny::checkboxInput(inputId = "roundtrip_plane", label = "Round trip", value = TRUE, width = "20%"),
                                                                                                                                                        shiny::splitLayout(shiny::verbatimTextOutput("plane_emissions"), htmltools::h6("emissions"), shiny::actionButton("add_plane", "Add to Table", class="btn-success"), cellArgs = list(style = "vertical-align: top")),
                                                                                                                 ),
                                                                                                                 shinydashboard::box(width = NULL,
                                                                                                                                     shiny::textInput(inputId = "airportname", label = "Check Airport Code:", value = "London Heathrow Airport"),
                                                                                                 ...
                                                                                                 shiny::tabPanel("Rail (UK)", 
                                                                                                                 shiny::splitLayout(shinydashboard::box(width = NULL,
                                                                                                                                                        shiny::textInput(inputId = "trainfrom", label = "From:", value = "Bristol Temple Meads", width = "41%"),
                                                                                                                                                        shiny::textInput(inputId = "trainto", label = "To:", value = "Paddington", width = "41%"),
                                                                                                                                                        shiny::numericInput("trainvia", "Via:", value = 0, min = 0, width = "41%"),
                                                                                                                                                        shiny::uiOutput("trainvia_input"),
                                                                                                                                                        shiny::numericInput(inputId = "numbertrain", label = "Number of people:", value = 1, width = "41%"),
                                                                                                                                                        shiny::numericInput(inputId = "timestrain", label = "Times Journey Made:", value = 1, width = "41%"),
                                                                                                                                                        shiny::checkboxInput(inputId = "roundtrip_train", label = "Round trip", value = TRUE, width = "20%"),
                                                                                                 ...
                                                                                                 shiny::tabPanel("Vehicle Transport",
                                                                                                                 shinydashboard::box(width = NULL, shiny::selectInput("vehicle", "Vehicle:", c("Car" = "car", "Van" = "van", "Taxi" = "taxi", "Motorbike" = "motorbike", "Bus" = "bus", "Coach" = "coach", "Tram" = "tram", "Tube" = "tube")),
                                                                                                                                     shiny::conditionalPanel(
                                                                                                                                       condition = "input.vehicle == 'car' | input.vehicle == 'van' | input.vehicle == 'motorbike'",
                                                                                                                                       shiny::radioButtons("size_vehicle", "Size:", c("Average" = "average", "Small" = "small", "Medium" = "medium", "Large" = "large")),
                                                                                                                                       shiny::conditionalPanel(condition = "input.vehicle == 'car'",
                                                                                                                                                               shiny::radioButtons("driven_gas", "Fuel Type:", c("Unleaded gasoline" = "petrol", "Diesel" = "diesel", "Unknown" = "unknown", "Hybrid" = "hybrid", "Hybrid Electric" = "hybrid electric", "Battery electric" = "battery electric"))),
                                                                                                                                       shiny::conditionalPanel(condition = "input.vehicle == 'van'",
                                                                                                                                                               shiny::radioButtons("driven_gas", "Fuel Type:", c("Unleaded gasoline" = "petrol", "Diesel" = "diesel", "Battery electric" = "battery electric"))),
                                                                                                                                     ),
                                                                                                                                     shiny::conditionalPanel(
                                                                                                                                       condition = "input.vehicle == 'bus'",
                                                                                                                                       shiny::radioButtons("driven_type", "Type:", c("Average" = "average", "Local (London)" = "local_L", "Local (Not London)" = "local_nL", "Local" = "local")),
                                                                                                                                     ),
                                                                                                                                     shiny::conditionalPanel(
                                                                                                                                       condition = "input.vehicle == 'taxi'",
                                                                                                                                       shiny::radioButtons("taxi_type", "Type:", c("Regular" = "regular", "Black Cab" = "black cab")),
                                                                                                                                     ),
                                                                                                                                     shiny::radioButtons("driven_units", "Units:", c("Miles" = "miles", "Kilometres" = "km")),
                                                                                                                                     shiny::numericInput(inputId = "drive_KM", label = "Distance driven:", value = "", width = "41%"),
                                                                                                                                     shiny::splitLayout(shiny::verbatimTextOutput("driven_emissions"), htmltools::h6("emissions"), shiny::actionButton("add_drive", "Add to Table", class="btn-success"), cellArgs = list(style = "vertical-align: top")),
                                                                                                                 )),
  ...
  server <- function(input, output) {
    ...
    carbon_calc <- shiny::reactive({
      ...
      airplane_emissions(from = input$flightfrom,
                         to = input$flightto,
                         via = C_P,
                         class = input$flightclass,
                         num_people = input$numberflying,
    ...
    train_carbon_calc <- shiny::reactive({
      ...
      rail_emissions(from = input$trainfrom,
                     to = input$trainto,
                     via = C,
                     num_people = input$numbertrain,
                     times_journey = input$timestrain,
                     round_trip = input$roundtrip_train)
    })
    output$train_emissions <- shiny::renderText({
      train_carbon_calc()
    })
