#' Calculate industrial material emissions
#'
...
#'
#' @examples
#' industrial_emissions(glass = 100, glass_WD = 10, units = "kg")
industrial_emissions <- function(glass = 0, board = 0, mixed = 0, paper = 0,
