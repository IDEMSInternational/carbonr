...
Carbon credit prices are additionally available in the `carbon_credit_price` function using the [World Bank data](https://carbonpricingdashboard.worldbank.org/). The jurisdiction and year available for that jurisdiction can be found in the `check_CPI()` function.
