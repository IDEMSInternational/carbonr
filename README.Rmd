...
These functions estimate emissions based on general activities, making them easier to use without detailed knowledge of specific inputs:
...
#### Clinical Emissions
Functions specific to calculating emissions from clinical and medical activities:
...
Below are some small examples demonstrating how to use the `carbonr` package functions. More comprehensive examples can be found in the vignette.
