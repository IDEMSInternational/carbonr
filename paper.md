...
# Statement of Need
Climate change and environmental sustainability are pressing global challenges that require sophisticated methods for assessing and mitigating carbon emissions across various sectors [@WHO2021]. Accurate carbon accounting is important to understand and reduce environmental impacts, however, the tools available to researchers and practitioners often fall short in terms of flexibility, transparency, and accessibility.
